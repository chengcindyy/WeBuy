...
public class SellerProcessingOrderListFragment extends Fragment {
    ...
    public SellerProcessingOrderListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_seller_processing_order_list, container, false);
        ...
        navController = NavHostFragment.findNavController(SellerProcessingOrderListFragment.this);

        rv = view.findViewById(R.id.rv_seller_order_list_processing);

        tv_no = view.findViewById(R.id.tv_seller_order_list_no_processing);
        ...
        orderRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (order.getOrderStatus() == 3 && order.getSellerId().equals(sellerId)) {
                        processingOrders.add(order);
                        Log.d(TAG, "onDataChange: allocatedOrders" + processingOrders);
                ...
                if (processingOrders.isEmpty()) {
                    ...
                    adapter = new SellerOrderListRecyclerAdapter(processingOrders, orderIds);
